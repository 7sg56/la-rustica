    ...
    return (
        ...
        >
            <div className="container mx-auto px-6 flex justify-between items-center">
                ...
                <button className="px-6 py-2 bg-primary text-primary-foreground text-xs font-bold uppercase tracking-widest rounded-sm hover:bg-primary/90 transition-colors">
                    Reserve
                </button>
            </div>
        </motion.nav>
